...
export default function DecisionPolicyPage() {
  const [policy, setPolicy] = useState(DecisionPolicyData);
  ...
  const handleSubmit = () => {
    setPolicy({
      allowMinScore: form.allowMinScore || policy.allowMinScore,
      allowMaxScore: form.allowMaxScore || policy.allowMaxScore,
      reviewMinScore: form.reviewMinScore || policy.reviewMinScore,
      reviewMaxScore: form.reviewMaxScore || policy.reviewMaxScore,
      blockMinScore: form.blockMinScore || policy.blockMinScore,
      blockMaxScore: form.blockMaxScore || policy.blockMaxScore,
      ...
      updatedTime: policy.createdTime,
    });
    setShowCreateModal(false);
