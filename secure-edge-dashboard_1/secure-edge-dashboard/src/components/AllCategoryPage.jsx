              ...
              <tbody>
                {paginatedData.length === 0 && (
                  <tr>
                    ...
                    >
                      No matching categories for the selected filters.
                    </td>
                  </tr>
                )}
                  ...
                  >
                    ...
                    <td className="relative px-4 py-4">
                      ...
                      {openActionId === item.id && (
                        <div className="absolute right-4 top-[calc(100%-4px)] z-10 flex w-[92px] flex-col rounded-md border border-[#E5E7EB] bg-white py-1 shadow-md">
                          <button
                            type="button"
                            className="px-3 py-1.5 text-left text-[12px] text-[#2F80ED] hover:bg-[#F8F9FB]"
